...
def send_sol(
    ...
    response = client.send_transaction(txn, src_keypair, opts=TxOpts(skip_preflight=True))
...
#                signers                 = [src_keypair,src_keypair,src_keypair]
        ...
        time.sleep(1)
        # sending transaction...
        resp = client.send_transaction(txn, src_keypair, opts=TxOpts(skip_preflight=True))
